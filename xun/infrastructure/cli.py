        ...
        'distributed': {
            'comm': {
                ...
                'tls': {
                    ...
                    'client-key': client.private_key_path,
                    'client-cert': client.cert_path,
                    'scheduler-key': scheduler.private_key_path,
                    'scheduler-cert': scheduler.cert_path,
                    'worker-key': worker.private_key_path,
                    'worker-cert': worker.cert_path,
                }
            },
        },
    })
...
def update_config(config):
    path = Path.home() / '.config/dask/xun-tls.yml'
